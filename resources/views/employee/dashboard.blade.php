    ...
    <div class="d-flex flex-column justify-content-center align-items-center min-vh-100">
        <nav class="fixed-top w-100 navbar navbar-expand-lg bg-body-tertiary shadow-sm shadow-bottom">
            <div class="container-fluid px-3">
                <div class="navbar-brand mx-2 fw-bold"><span class="custom-bg-text">L</span>MS / DASHBOARD</div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-center">
                        <div class="card shadow mb-4 w-100">
                            <div class="card-body">
                                <h5 class="card-title mb-3">Apply <br>For A Leave</h5>
                                <h6 class="mb-3">&nbsp;</h6>
                                <a href="{{route('account.apply')}}" class="btn custom-btn">Apply</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-center">
                        <div class="card shadow mb-4 w-100">
                            <div class="card-body">
                                <h5 class="card-title mb-3">Leave <br>Statuses</h5>
                                <h6 class="mb-3">&nbsp;</h6>
                                <a href="{{route('account.leavestatuses')}}" class="btn custom-btn">Visit</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-center">
