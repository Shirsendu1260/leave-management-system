...
<head>
    ...
    <title>LMS • Total Employees</title>
    ...
    <div class="d-flex flex-column justify-content-center align-items-center">
        <nav class="w-100 navbar navbar-expand-lg bg-body-tertiary shadow-sm shadow-bottom">
            <div class="container-fluid px-3">
                <div class="navbar-brand mx-2 fw-bold"><span class="custom-bg-text">L</span>MS / TOTAL EMPLOYEES</div>
            ...
            <div class="card shadow">
                <div class="custom-bg rounded-top">
                    <div class="d-flex justify-content-between m-0 p-3 text-white">
                        <h5 class="m-0 d-flex align-items-center">Registered Employees</h5>
                        ...
                        <table class="table table-striped" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr valign="middle">
                                    <td>{{ $employee->id }}</td>
                                    <td>
                                        @if($employee->photo != '' && file_exists(public_path() . '/uploads/users/'
                                        .
                                        $employee->photo))
                                        <img src="{{ url('/uploads/users/' . $employee->photo) }}" width="50"
